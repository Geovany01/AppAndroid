...
import com.example.appproductos.interfaces.ProductoApi;
...
public class MainActivity extends AppCompatActivity {
    ...
    private void find(String codigo) {
        Retrofit retrofit = new Retrofit.Builder().baseUrl("http://localhost:5001/")
        ...
        call.enqueue(new Callback<Producto>() {
            ...
            public void onResponse(Call<Producto> call, Response<Producto> response) {
                try {
                    if(response.isSuccessful()) {
                        ...
                        tvNombre.setText(p.getProducto());
                        tvDescripcion.setText(p.getDescripcion());
                        tvPrecio.setText(p.getImagen());
            ...
            public void onFailure(Call<Producto> call, Throwable t) {
                Toast.makeText(MainActivity.this, "xError de red", Toast.LENGTH_SHORT);
            }
        });
    }
